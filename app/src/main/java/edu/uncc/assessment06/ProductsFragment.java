...
public class ProductsFragment extends Fragment {
                    ...
                    public void onClick(View view) {
                        {
                            ...
                            data.put("item_id", docRef.getId());
                            data.put("pid", product.getPid());
                            data.put("name", product.getName());
                            data.put("img_url", product.getImg_url());
                            data.put("price", product.getPrice());
                            data.put("description",product.getDescription());
                            data.put("review_count",product.getReview_count());
                            data.put("added_by",mAuth.getCurrentUser().getUid());
    ...
    ProductFragmentListener mListener;
